...
{#if isOpen}
	<div class="modal-wrapper" onclick={handleClose}>
		<div class="modal" onclick={stopPropagation(bubble('click'))}>
			...
			<p>
				Using these, it will derive a password, which you can set as your new password for that
				site.
			</p>
			<p>
				The next time you need it, enter the same site and same cipher key. Obliviate will derive
